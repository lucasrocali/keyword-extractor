...
describe("extractor", function () {
    ...
    it("should return an array of 'keywords' for a Portuguese string with sanatized text", function () {
        var extraction_result = extractor.extract("Petróleo avança com pacote de estímulo nos EUA, mas demanda afunda https://t.co/xxV35Vdl9I #petróleo", {
            language: "portuguese",
            return_changed_case: true,
            remove_links: true
        });
        ...
        extraction_result.should.not.be.empty;
        extraction_result.should.eql(["petróleo", "avança", "pacote", "estímulo", "eua", "demanda", "afunda", "#petróleo"]);
    });

    it("should return an array of 'keywords' for a Portuguese string with sanatized text and remove optional regexs", function () {
        var extraction_result = extractor.extract(" :chart_with_upwards_trend: Maiores altas do Ibovespa \n\nGOLL4 +35,06% R$ 10,84\nBRKM5 +31,75% R$ 15,02\nRENT3 +26,82% R$ 34,47\nCIEL3 +23,46% R$ 5,00\nYDUQ3 -23,06% R$ 26,79", {
            language: "portuguese",
            return_changed_case: true,
            remove_links: true,
            remove_digits: true,
        ...
        extraction_result.should.not.be.empty;
        extraction_result.should.eql(["maiores", "altas", "ibovespa", "goll4", "brkm5", "rent3", "ciel3", "yduq3"]);
    });

    it("should return an array of 'keywords' for a Portuguese string with sanatized text and remove optional regexs", function () {
        var extraction_result = extractor.extract("BDM Online [26.03.20 17:16]\n++ Ibovespa fecha em alta de 3,67% (77.709,66 pontos), com volume financeiro de R$ 30,1 bilhões", {
            language: "portuguese",
            return_changed_case: true,
            remove_links: true,
            remove_digits: true,
        ...
        extraction_result.should.not.be.empty;
        extraction_result.should.eql(["bdm", "online", "ibovespa", "fecha", "alta", "volume", "financeiro", "bilhões"]);
    });
